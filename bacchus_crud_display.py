...
sql = "CREATE TABLE employees(employee_id int NOT NULL AUTO_INCREMENT PRIMARY KEY, employee_name varchar(75) NOT NULL,\
    q_1 int NOT NULL, q_2 int NOT NULL, q_3 int NOT NULL, q_4 int NOT NULL)"
mycursor.execute(sql)

# Create distributor table
sql2 = "CREATE TABLE distributor(distributor_id int NOT NULL AUTO_INCREMENT PRIMARY KEY, \
   distributor_name varchar(75) NOT NULL, location varchar(100) NULL, wine_name varchar(75) NOT NULL)"
...
# Create wine table
sql4 = "CREATE TABLE wine(wine_id int NOT NULL AUTO_INCREMENT PRIMARY KEY, wine_name varchar(75) NOT NULL, \
   bottles_sold int NOT NULL, distributor_id int NOT NULL)"
mycursor.execute(sql4)

# Create deliveries table
sql5 = "CREATE TABLE deliveries(supplier_id int NOT NULL, jan varchar(100) NULL, feb varchar(100) NULL, \
   mar varchar(100) NULL, apr varchar(100) NULL, may varchar(100) NULL, jun varchar(100) NULL, jul varchar(100) NULL, \
   aug varchar(100) NULL, sep varchar(100) NULL, oct varchar(100) NULL, nov varchar(100) NULL, decem varchar(100) NULL)"
mycursor.execute(sql5)

# Create supplier table
sql6 = "CREATE TABLE supplier(supplier_id int NOT NULL AUTO_INCREMENT PRIMARY KEY, supplier_name varchar(75) NOT NULL, \
...
sql_insert = "INSERT INTO deliveries(supplier_id, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, decem) \
   VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

val = [
   (4, "Expected: 011220 Actual: 011020", "Expected: 021020 Actual: 021020", "Expected: 031120 Actual: 032020", + 
   "Expected: 041520 Actual: 041620", "Expected: 051420 Actual: 050520", "Expected: 062020 Actual: 061020", + 
   "Expected: 071220 Actual: 070820", "Expected: 081720 Actual: 081020", "Expected: 091720 Actual: 091620", + 
   "Expected: 101220 Actual: 101020", "Expected: 111220 Actual: 112120", "Expected: 120720 Actual: 121020",),
   (5, "Expected: 010820 Actual: 011020", "Expected: 020420 Actual: 021020", "Expected: 032120 Actual: 033020", +
    "Expected: 041620 Actual: 041620", "Expected: 052020 Actual: 052120", "Expected: 060320 Actual: 061020", + 
    "Expected: 070220 Actual: 070420", "Expected: 081120 Actual: 080320", "Expected: 090620 Actual: 091720", + 
    "Expected: 100320 Actual: 101920", "Expected: 112120 Actual: 112520", "Expected: 120320 Actual: 121920",),
   (6, "Expected: 011620 Actual: 011620", "Expected: 021520 Actual: 021320", "Expected: 032020 Actual: 031020", +
   "Expected: 042520 Actual: 042620", "Expected: 050420 Actual: 050520", "Expected: 062020 Actual: 061520", + 
   "Expected: 071920 Actual: 070920", "Expected: 081520 Actual: 081120", "Expected: 092020 Actual: 090420", + 
   "Expected: 100220 Actual: 101120", "Expected: 110220 Actual: 110220", "Expected: 120420 Actual: 121820",),
   (7, "Expected: 011220 Actual: 011020", "Expected: 021020 Actual: 021020", "Expected: 031120 Actual: 032020", + 
   "Expected: 041520 Actual: 041620", "Expected: 051420 Actual: 050520", "Expected: 062020 Actual: 061020", + 
   "Expected: 071220 Actual: 070820", "Expected: 081720 Actual: 081020", "Expected: 091720 Actual: 091620", + 
   "Expected: 101220 Actual: 101020", "Expected: 111220 Actual: 112120", "Expected: 120720 Actual: 121020",),
   (8, "Expected: 012220 Actual: 011920", "Expected: 022220 Actual: 022220", "Expected: 031720 Actual: 031020", +
    "Expected: 042020 Actual: 041520", "Expected: 051320 Actual: 050320", "Expected: 062620 Actual: 060320", + 
    "Expected: 071920 Actual: 070920", "Expected: 081420 Actual: 081320", "Expected: 091620 Actual: 091620", + 
    "Expected: 101320 Actual: 101320", "Expected: 111520 Actual: 112520", "Expected: 120820 Actual: 121520",),
   (9, "Expected: 011220 Actual: 011020", "Expected: 021020 Actual: 021020", "Expected: 031120 Actual: 032020", + 
   "Expected: 041520 Actual: 041620", "Expected: 051420 Actual: 050520", "Expected: 062020 Actual: 061020", + 
   "Expected: 071220 Actual: 070820", "Expected: 081720 Actual: 081020", "Expected: 091720 Actual: 091620", + 
   "Expected: 101220 Actual: 101020", "Expected: 111220 Actual: 112120", "Expected: 120720 Actual: 121020",)
]
